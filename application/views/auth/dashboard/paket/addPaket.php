<div class="row center-align">  
  <div class="col s9" style="padding-left: 200px;">
      	<h3 class="flow-text">Tambah data paket</h3>
      	<form class="col s12" method="POST" action="<?= base_url('paket/simpanpaket'); ?>">
	      	<div class="row">
	            <div class="input-field col s12">
	              <input name="nama_paket" id="nama_paket" type="text" class="validate">
	        ...
	        <div class="row">
	            <div class="input-field col s12">
	              <input name="deskripsi_paket" id="deskripsi_paket" type="text" class="validate">
