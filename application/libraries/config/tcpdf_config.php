 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE','D SEUSEUH LAUNDRY','C');

/**
 * Header description string.
 */

define ('PDF_HEADER_STRING', "JL.Terusan Kopo No.252, Katapang\nmail@example.com");
// JL.Terusan Kopo No.252, Katapang - mail@example.com
/**
